...
public class IfcTimeSeriesSchedule extends IfcControl 
{
	...
	private List<IfcDateTimeSelect> ApplicableDates = new ArrayList<IfcDateTimeSelect>();
	...
	public void setTimeSeriesScheduleType(IfcTimeSeriesScheduleTypeEnum value){
