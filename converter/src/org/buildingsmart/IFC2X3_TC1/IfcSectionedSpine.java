...
public class IfcSectionedSpine extends IfcGeometricRepresentationItem 
{
	...
	private List<IfcProfileDef> CrossSections = new ArrayList<IfcProfileDef>();
	private List<IfcAxis2Placement3D> CrossSectionPositions = new ArrayList<IfcAxis2Placement3D>();
