...
public class IfcCShapeProfileDef extends IfcParameterizedProfileDef 
{
	...
	private IfcPositiveLengthMeasure CentreOfGravityInX_of_IfcCShapeProfileDef;
	...
	public void setInternalFilletRadius(IfcPositiveLengthMeasure value){
		this.InternalFilletRadius=value;
	}

	public IfcPositiveLengthMeasure getCentreOfGravityInX_of_IfcCShapeProfileDef() {
		return CentreOfGravityInX_of_IfcCShapeProfileDef;
	}

	public void setCentreOfGravityInX_of_IfcCShapeProfileDef(IfcPositiveLengthMeasure value){
		this.CentreOfGravityInX_of_IfcCShapeProfileDef=value;
	}
