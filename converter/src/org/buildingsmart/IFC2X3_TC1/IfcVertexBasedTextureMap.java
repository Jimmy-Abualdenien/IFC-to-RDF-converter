...
public class IfcVertexBasedTextureMap extends Thing 
{
	...
	private List<IfcTextureVertex> TextureVertices = new ArrayList<IfcTextureVertex>();
	private List<IfcCartesianPoint> TexturePoints = new ArrayList<IfcCartesianPoint>();
