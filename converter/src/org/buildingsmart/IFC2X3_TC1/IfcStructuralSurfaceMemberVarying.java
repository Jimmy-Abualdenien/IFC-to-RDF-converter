...
public class IfcStructuralSurfaceMemberVarying extends IfcStructuralSurfaceMember 
{
	...
	private List<IfcPositiveLengthMeasure> SubsequentThickness = new ArrayList<IfcPositiveLengthMeasure>();
	...
	public void setSubsequentThickness(IfcPositiveLengthMeasure value){
		this.SubsequentThickness.add(value);
	}
