...
public class IfcWindowStyle extends IfcTypeProduct 
{
	...
	private Boolean ParameterTakesPrecedence_of_IfcWindowStyle;
	private Boolean Sizeable_of_IfcWindowStyle;
	...
	public Boolean getParameterTakesPrecedence_of_IfcWindowStyle() {
		return ParameterTakesPrecedence_of_IfcWindowStyle;
	}

	public void setParameterTakesPrecedence_of_IfcWindowStyle(Boolean value){
		this.ParameterTakesPrecedence_of_IfcWindowStyle=value;
	}

	public Boolean getSizeable_of_IfcWindowStyle() {
		return Sizeable_of_IfcWindowStyle;
	}

	public void setSizeable_of_IfcWindowStyle(Boolean value){
