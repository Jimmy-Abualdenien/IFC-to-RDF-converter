...
public class IfcDoorStyle extends IfcTypeProduct 
{
	...
	private Boolean ParameterTakesPrecedence_of_IfcDoorStyle;
	private Boolean Sizeable_of_IfcDoorStyle;
	...
	public Boolean getParameterTakesPrecedence_of_IfcDoorStyle() {
		return ParameterTakesPrecedence_of_IfcDoorStyle;
	}

	public void setParameterTakesPrecedence_of_IfcDoorStyle(Boolean value){
		this.ParameterTakesPrecedence_of_IfcDoorStyle=value;
	}

	public Boolean getSizeable_of_IfcDoorStyle() {
		return Sizeable_of_IfcDoorStyle;
	}

	public void setSizeable_of_IfcDoorStyle(Boolean value){
