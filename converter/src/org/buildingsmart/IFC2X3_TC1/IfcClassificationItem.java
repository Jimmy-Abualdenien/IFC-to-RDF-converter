...
public class IfcClassificationItem extends Thing 
{
 ...
 // The inverse attributes
	...
	public void setTitle(IfcLabel value){
		this.Title=value;
	}

	// Getters and setters of inverse values

	public List<IfcClassificationItemRelationship> getIsClassifiedItemIn() {
	...
	public List<IfcClassificationItemRelationship> getIsClassifyingItemIn() {
