...
public class IfcZShapeProfileDef extends IfcParameterizedProfileDef 
{
	...
	private IfcPositiveLengthMeasure FilletRadius_of_IfcZShapeProfileDef;
	private IfcPositiveLengthMeasure EdgeRadius_of_IfcZShapeProfileDef;
	...
	public IfcPositiveLengthMeasure getFilletRadius_of_IfcZShapeProfileDef() {
		return FilletRadius_of_IfcZShapeProfileDef;
	}

	public void setFilletRadius_of_IfcZShapeProfileDef(IfcPositiveLengthMeasure value){
		this.FilletRadius_of_IfcZShapeProfileDef=value;
	}

	public IfcPositiveLengthMeasure getEdgeRadius_of_IfcZShapeProfileDef() {
		return EdgeRadius_of_IfcZShapeProfileDef;
	}

	public void setEdgeRadius_of_IfcZShapeProfileDef(IfcPositiveLengthMeasure value){
