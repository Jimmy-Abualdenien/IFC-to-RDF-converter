...
public class IfcUShapeProfileDef extends IfcParameterizedProfileDef 
{
	...
	private IfcPositiveLengthMeasure FilletRadius_of_IfcUShapeProfileDef;
	private IfcPositiveLengthMeasure EdgeRadius_of_IfcUShapeProfileDef;
	private IfcPlaneAngleMeasure FlangeSlope_of_IfcUShapeProfileDef;
	private IfcPositiveLengthMeasure CentreOfGravityInX_of_IfcUShapeProfileDef;
	...
	public IfcPositiveLengthMeasure getFilletRadius_of_IfcUShapeProfileDef() {
		return FilletRadius_of_IfcUShapeProfileDef;
	}

	public void setFilletRadius_of_IfcUShapeProfileDef(IfcPositiveLengthMeasure value){
		this.FilletRadius_of_IfcUShapeProfileDef=value;
	}

	public IfcPositiveLengthMeasure getEdgeRadius_of_IfcUShapeProfileDef() {
		return EdgeRadius_of_IfcUShapeProfileDef;
	}

	public void setEdgeRadius_of_IfcUShapeProfileDef(IfcPositiveLengthMeasure value){
	...
	public IfcPositiveLengthMeasure getCentreOfGravityInX_of_IfcUShapeProfileDef() {
		return CentreOfGravityInX_of_IfcUShapeProfileDef;
	}

	public void setCentreOfGravityInX_of_IfcUShapeProfileDef(IfcPositiveLengthMeasure value){
		this.CentreOfGravityInX_of_IfcUShapeProfileDef=value;
	}
