...
public class IfcPerson extends Thing implements IfcActorSelect, IfcObjectReferenceSelect
{
	...
	private IfcIdentifier Id_of_IfcPerson;
 ...
 // The inverse attributes
	...
	public IfcIdentifier getId_of_IfcPerson() {
		return Id_of_IfcPerson;
	}

	public void setId_of_IfcPerson(IfcIdentifier value){
		this.Id_of_IfcPerson=value;
	}
