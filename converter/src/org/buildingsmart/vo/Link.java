...
public class Link {
	...
	private int listIndex = Integer.MIN_VALUE; // if this is part of a list, the
												// index it has
	...
	public String neatString() {
		String retval = "";
		retval += " " + t1.getLine_number() + "."
				+ t1.getClass().getSimpleName() + "  -" + property + "- " + " "
				+ t2.getLine_number() + "." + t2.getClass().getSimpleName();
		return retval;
	}
