...
public class IfcObjective extends IfcConstraint 
{
	...
	private List<IfcConstraint> BenchmarkValues = new ArrayList<IfcConstraint>();
	...
	public void setBenchmarkValues(IfcConstraint value){
		this.BenchmarkValues.add(value);
	}
