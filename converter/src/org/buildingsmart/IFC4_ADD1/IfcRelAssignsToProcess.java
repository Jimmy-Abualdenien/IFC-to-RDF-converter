...
public class IfcRelAssignsToProcess extends IfcRelAssigns 
{
	...
	private IfcProcessSelect RelatingProcess_of_IfcRelAssignsToProcess;
	private IfcMeasureWithUnit QuantityInProcess;


	// Getters and setters of properties
	public IfcProcessSelect getRelatingProcess_of_IfcRelAssignsToProcess() {
		return RelatingProcess_of_IfcRelAssignsToProcess;
	}

	public void setRelatingProcess_of_IfcRelAssignsToProcess(IfcProcessSelect value){
