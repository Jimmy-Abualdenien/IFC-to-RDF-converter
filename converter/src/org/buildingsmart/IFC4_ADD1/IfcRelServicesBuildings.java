...
public class IfcRelServicesBuildings extends IfcRelConnects 
{
	...
	private List<IfcSpatialElement> RelatedBuildings = new ArrayList<IfcSpatialElement>();
	...
	public List<IfcSpatialElement> getRelatedBuildings() {
		return RelatedBuildings;
	}

	public void setRelatedBuildings(IfcSpatialElement value){
