...
public class IfcOrganization extends Thing implements IfcActorSelect, IfcObjectReferenceSelect, IfcResourceObjectSelect
{
	// The property attributes
	private IfcIdentifier Identification_of_IfcOrganization;
	...
	public IfcIdentifier getIdentification_of_IfcOrganization() {
		return Identification_of_IfcOrganization;
	}

	public void setIdentification_of_IfcOrganization(IfcIdentifier value){
		this.Identification_of_IfcOrganization=value;
	}
