...
public class IfcGrid extends IfcProduct 
{
	...
	public IfcGridTypeEnum getPredefinedType_of_IfcGrid() {
		return PredefinedType_of_IfcGrid;
	}

	public void setPredefinedType_of_IfcGrid(IfcGridTypeEnum value){
		this.PredefinedType_of_IfcGrid=value;
	}
