...
public class IfcStructuralSurfaceMember extends IfcStructuralMember 
{
	...
	private IfcStructuralSurfaceMemberTypeEnum PredefinedType_of_IfcStructuralSurfaceMember;
	private IfcPositiveLengthMeasure Thickness_of_IfcStructuralSurfaceMember;


	// Getters and setters of properties
	public IfcStructuralSurfaceMemberTypeEnum getPredefinedType_of_IfcStructuralSurfaceMember() {
		return PredefinedType_of_IfcStructuralSurfaceMember;
	}

	public void setPredefinedType_of_IfcStructuralSurfaceMember(IfcStructuralSurfaceMemberTypeEnum value){
