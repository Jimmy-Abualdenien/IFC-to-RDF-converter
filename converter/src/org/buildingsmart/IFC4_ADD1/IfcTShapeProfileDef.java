...
public class IfcTShapeProfileDef extends IfcParameterizedProfileDef 
{
	...
	private IfcNonNegativeLengthMeasure FilletRadius_of_IfcTShapeProfileDef;
	private IfcNonNegativeLengthMeasure FlangeEdgeRadius_of_IfcTShapeProfileDef;
	...
	public IfcNonNegativeLengthMeasure getFilletRadius_of_IfcTShapeProfileDef() {
		return FilletRadius_of_IfcTShapeProfileDef;
	}

	public void setFilletRadius_of_IfcTShapeProfileDef(IfcNonNegativeLengthMeasure value){
		this.FilletRadius_of_IfcTShapeProfileDef=value;
	}

	public IfcNonNegativeLengthMeasure getFlangeEdgeRadius_of_IfcTShapeProfileDef() {
		return FlangeEdgeRadius_of_IfcTShapeProfileDef;
	}

	public void setFlangeEdgeRadius_of_IfcTShapeProfileDef(IfcNonNegativeLengthMeasure value){
		this.FlangeEdgeRadius_of_IfcTShapeProfileDef=value;
	}
	...
	public void setWebEdgeRadius(IfcNonNegativeLengthMeasure value){
