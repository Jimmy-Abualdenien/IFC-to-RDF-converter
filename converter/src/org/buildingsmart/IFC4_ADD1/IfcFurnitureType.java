...
public class IfcFurnitureType extends IfcFurnishingElementType 
{
	...
	private IfcFurnitureTypeEnum PredefinedType_of_IfcFurnitureType;
	...
	public IfcFurnitureTypeEnum getPredefinedType_of_IfcFurnitureType() {
		return PredefinedType_of_IfcFurnitureType;
	}

	public void setPredefinedType_of_IfcFurnitureType(IfcFurnitureTypeEnum value){
		this.PredefinedType_of_IfcFurnitureType=value;
	}
