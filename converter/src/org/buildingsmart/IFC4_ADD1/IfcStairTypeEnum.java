...
public class IfcStairTypeEnum extends Thing
{
	...
	public IfcStairTypeEnum_value getIfcStairTypeEnum() {
		return value;
	}

	public void setIfcStairTypeEnum(IfcStairTypeEnum_value value){
		this.value=value;
	}
